      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-5 m-t">
            ...
            <p className="main-p m-t" alt="Katie Liu">A full-time developer, digital art hobbyist, and occasional freelancer.<br/><br/>Continue browsing<br className="d-none d-md-inline"/> to learn more about me.</p>
