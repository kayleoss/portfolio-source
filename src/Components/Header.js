      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-sm-5 m-t">
            <h1 className="main-h1 wow fadeInDown m-t">I'm Katie <span role="img" aria-label="waving hand">👋</span></h1>
            <p className="main-p m-t wow fadeIn" alt="Katie Liu">A full-time developer, digital art hobbyist, and occasional freelancer.<br/><br/>Continue browsing to see what I can do for you, my recent projects, and art store.</p>
